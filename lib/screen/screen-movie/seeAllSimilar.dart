...
class seeAllSimilar extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocConsumer<MovieCubit, MovieStates>(
      ...
      builder: (context, state) {
        ...
        var genreMoviesDetails = MovieCubit.get(context).similarMovies;
        return Scaffold(
          appBar: AppBar(
