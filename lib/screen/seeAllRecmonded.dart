...
class SeeAllRecomendedScreen extends StatelessWidget {
  SeeAllRecomendedScreen(this.id);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<MovieCubit, MovieStates>(
      ...
      builder: (context, state) {
        ...
        var genreMoviesDetails = MovieCubit.get(context).recommendedMovies;
        return Scaffold(
          appBar: AppBar(
                            ...
                            onTap: () {
                              navigateTo(
                                ...
                                child: MovieDetail(
                                  ...
                                  overview: genreMoviesDetails
                                      .results![index].overview,
                                  title:
                                      genreMoviesDetails.results![index].title,
